            ...
            <Tooltip>
              ...
              <TooltipContent>
                <p className="max-w-xs">
                  Inbound numbers are used for customers to call your business. 
                  Incoming calls will be automatically handled by your AI voice agent.
                </p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
        ...
        <div className="flex items-center justify-between">
          ...
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent>
                <p className="max-w-xs">
                  Outbound numbers are used for your AI agents to make outgoing calls 
                  to leads and customers. This is what appears on their caller ID.
                </p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
      ...
      <CardContent>
        <div className="space-y-4">
          ...
          <div className="p-4 border border-border/50 rounded-2xl bg-card/30">
            <h3 className="text-base font-medium mb-4">Outbound Settings</h3>
            ...
            <div className="grid gap-4">
              <div className="flex flex-col space-y-1.5">
                ...
                <Select value={callerId} onValueChange={setCallerId}>
                  <SelectTrigger id="callerId" className="rounded-lg">
                    <SelectValue placeholder="Select a caller ID to display" />
                  </SelectTrigger>
                  <SelectContent position="popper">
                    <SelectItem value="default">IcePhone Sales</SelectItem>
                    <SelectItem value="company">Your Company Name</SelectItem>
                    <SelectItem value="local">Local Area Match (Smart)</SelectItem>
              ...
              <div className="flex items-center justify-between rounded-lg border p-4">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Only make outbound calls during business hours
                  </p>
                </div>
                <Switch
                  id="scheduleToggle"
    ...
    <>
      ...
      <Tabs defaultValue="all" className="mb-6">
        <TabsList className="rounded-full bg-muted/80 shadow-inner">
          <TabsTrigger value="all" className="px-6 text-base font-medium rounded-full">
            All Numbers
          </TabsTrigger>
          <TabsTrigger value="inbound" className="px-6 text-base font-medium rounded-full">
            Inbound
          </TabsTrigger>
          <TabsTrigger value="outbound" className="px-6 text-base font-medium rounded-full">
            Outbound
          </TabsTrigger>
        </TabsList>
