...
import { fadeIn, staggerContainer, transition } from "@/lib/calendar/animations"
...
import { WeekViewMultiDayEventsRow } from "@/lib/calendar/components/week-and-day-view/week-view-multi-day-events-row"
								...
								{weekDays.map((day, dayIndex) => {
									const dayEvents = singleDayEvents.filter(
										(event) => {
											...
											const eventEndDate = parseISO(
												event.endDate
											)

											// For week view, we only want to display an event on the day it starts
											// For all-day or multi-day events, they're handled separately in the multi-day events row
											if (
												isSameDay(
													eventStartDate,
													eventEndDate
