...
export const SCENE_STARTS = {
  ...
  buildAgent: SCENE_DURATIONS.problem + SCENE_DURATIONS.solution - 2 * TRANSITION_DURATION, // 180
  connectStack: SCENE_DURATIONS.problem + SCENE_DURATIONS.solution + SCENE_DURATIONS.buildAgent - 3 * TRANSITION_DURATION, // 345
  launchMonitor: SCENE_DURATIONS.problem + SCENE_DURATIONS.solution + SCENE_DURATIONS.buildAgent + SCENE_DURATIONS.connectStack - 4 * TRANSITION_DURATION, // 510
  cta: SCENE_DURATIONS.problem + SCENE_DURATIONS.solution + SCENE_DURATIONS.buildAgent + SCENE_DURATIONS.connectStack + SCENE_DURATIONS.launchMonitor - 5 * TRANSITION_DURATION, // 675
} as const;
